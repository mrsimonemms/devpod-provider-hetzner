...
func main() {
	...
	for _, t := range serverTypes {
		machineTypes = append(machineTypes, t.Name)
	}
...
func BuildConfig(version string, checksum map[string]string, defaultRegion string, regions []string, defaultMachineType string, machineTypes []string) provider.ProviderConfig {
